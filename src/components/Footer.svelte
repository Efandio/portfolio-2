...
<footer id="footer" class="w-full h-fit mt-30 py-4 bg-primary flex flex-col gap-1 justify-center items-center">
    <h5 class="italic font-medium text-background">Feel free to message me on</h5>
    <p class="italic font-medium text-background flex items-center gap-1 text-xs">
